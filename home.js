...
const canWeDeliver = (zipCode) => { 
    let arr = []                                 //how can we check if the zipcode being passed in, is in the array?
    for(i = 0; i < arr.length; i++)
    if (zipCode === arr){                                            //we need to check it, so make a for loop
...
const monthDeal = deals[1].desc.replace('march', 'april')
